...
import com.example.news.utils.InsecureSHA1PRNGKeyDerivator;
...
public class AESUtil {
	...
	public static String encrypt(String data) {
		return des(data, password, Cipher.ENCRYPT_MODE);
	}
	...
	public static String decrypt(String data) {
		return des(data, password, Cipher.DECRYPT_MODE);
	}
	...
	private static SecretKeySpec deriveKeyInsecurely(String password) {
		...
		return new SecretKeySpec(InsecureSHA1PRNGKeyDerivator.deriveInsecureKey(passwordBytes, AESUtil.KEY_SIZE), "AES");
	}
